...
namespace HotelProject.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //apinin frontend birimler içerisinde kullanýlmasýný saðlar
            ...
            //iliþkili tablolarda verileri getirmek için eklendi
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors("OtelApiCors"); //api'nin frontend katmanlar ile kullanýlmasýný saðlar
