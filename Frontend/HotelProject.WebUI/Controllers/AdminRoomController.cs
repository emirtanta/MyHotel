...
namespace HotelProject.WebUI.Controllers
{
    public class AdminRoomController : Controller
    {
        ...
        public async Task<IActionResult> AddRoom(CreateRoomDto createRoomDto)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:1179/api/Room", stringContent);
        ...
        public async Task<IActionResult> UpdateRoom(UpdateRoomDto updateRoomDto)
        {
            ...
            var responseMessage = await client.PutAsync("http://localhost:1179/api/Room/", stringContent);
        ...
        #region oda silme bölümü

        public async Task<IActionResult> DeleteRoom(int id)
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"http://localhost:1179/api/Room/{id}");
